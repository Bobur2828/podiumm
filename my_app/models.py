...
class Client(models.Model):
    ...
    addres = models.CharField(max_length=255, unique=True, null=True)
    def __str__(self):
        return self.name
...
class Profile(models.Model):
    ...
    user = models.OneToOneField(User, on_delete=models.CASCADE,blank=True, null=True, default=User.id)
    image = models.ImageField(upload_to="product/photo",  blank=True, default=None,null=True, verbose_name='Tovar fotosini kiriting')

    date_updated=models.DateField(User,auto_now=True,)
    phone_number=models.CharField(max_length=13,  blank=True, null=True, default=True)
    country=models.CharField(max_length=100, choices=DAVLAT,  blank=True, null=True,  )
    city=models.CharField(max_length=100,choices=SHAXAR, blank=True, null=True, )
